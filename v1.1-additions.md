...
**GET /banks/BANK_ID/accounts/ACCOUNT_ID/VIEW_ID/other_accounts/OTHER_ACCOUNT_ID/alias**

Gets the alias for other acount OTHER_ACCOUNT_ID for view VIEW_ID on account ACCOUNT_ID.
...
Creates the public alias for other acount OTHER_ACCOUNT_ID for account ACCOUNT_ID. Note: Public
...
Updates the public alias for other acount OTHER_ACCOUNT_ID for account ACCOUNT_ID. The VIEW_ID parameter
...
Deletes the public alias for other acount OTHER_ACCOUNT_ID for ACCOUNT_ID. The VIEW_ID parameter
should be a view the caller is permitted to access that has permission to edit public aliases.

**POST /banks/BANK_ID/accounts/ACCOUNT_ID/VIEW_ID/other_accounts/OTHER_ACCOUNT_ID/private_alias**

Creates the private alias for other acount OTHER_ACCOUNT_ID for account ACCOUNT_ID. The VIEW_ID parameter
...
Updates the private alias for other acount OTHER_ACCOUNT_ID for account ACCOUNT_ID. The VIEW_ID parameter
should be a view the caller is permitted to access that has permission to edit private aliases.
...
Deletes the private alias for other acount OTHER_ACCOUNT_ID for ACCOUNT_ID. The VIEW_ID parameter
should be a view the caller is permitted to access that has permission to edit public aliases.
